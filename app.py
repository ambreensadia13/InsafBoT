...
st.markdown(import htmlimport osimport reimport streamlit as stfrom openai import OpenAIfrom rag import build_database, search_laws============================================================PAGE CONFIG============================================================st.set_page_config(page_title="INSAFBOT",page_icon="⚖️",layout="wide",)============================================================CSS============================================================st.markdown("""html, body, [data-testid="stApp"], [data-testid="stAppViewContainer"] {     background-color: #0f172a !important; }  * {     box-sizing: border-box; }  .main .block-container {     max-width: 1200px !important;     padding-top: 2rem !important;     padding-bottom: 2rem !important;     padding-left: 2rem !important;     padding-right: 2rem !important; }  /* SIDEBAR */  section[data-testid="stSidebar"] {     background-color: #0b1120 !important;     border-right: 1px solid #1e293b !important; }  section[data-testid="stSidebar"] > div {     background-color: #0b1120 !important; }  .sidebar-title {     color: #f8fafc !important;     font-size: 1.55rem !important;     font-weight: 800 !important;     margin-bottom: 0.2rem !important; }  .sidebar-subtitle {     color: #94a3b8 !important;     font-size: 0.88rem !important;     margin-bottom: 1.5rem !important; }  /* SIDEBAR SELECTBOX */  section[data-testid="stSidebar"] div[data-baseweb="select"] > div {     background-color: #111827
