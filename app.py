...
/* ========================================================
   ALL SELECTBOXES
   Force fixed dark colour across browsers
   ======================================================== */
...
div[data-baseweb="select"] [role="combobox"]:hover {
    background: #111827 !important;
}

/* ========================================================
   STREAMLIT / BASEWEB DROPDOWN POPUP
   IMPORTANT:
   The popup is outside the sidebar in many browsers.
   Therefore these selectors are intentionally GLOBAL.
   ======================================================== */
...
/* ========================================================
   MAIN TITLE
   Fixed size + no wrapping + no clipping
   ======================================================== */
...
Do not create citations that are not present
